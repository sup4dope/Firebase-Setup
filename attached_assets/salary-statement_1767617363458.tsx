...
interface SalaryStatementProps {
  ...
  // 공제 정보
  incomeTaxRate?: number // 기본 3%
  localTaxRate?: number // 기본 0.3%
...
export function SalaryStatement({
  ...
  return (
    <div className="w-[210mm] h-[297mm] bg-white shadow-lg p-[12mm] flex flex-col page-break">
      {/* Header */}
        ...
        <div className="flex justify-between items-start mb-3">
          ...
          <div className="flex items-start gap-6">
            <div className="text-right">
              <div className="text-xl font-bold text-teal-800 mb-1">{companyLogo}</div>
              <div className="text-[10px] text-teal-600">{companyName}</div>
            </div>
