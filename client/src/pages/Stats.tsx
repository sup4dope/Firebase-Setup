...
const ENTRY_SOURCES = ['광고', '캐시노트 인앱광고', '구글애즈', '구글애즈(QS)', '구글애즈(QSe)', '구글애즈(e)', '외주', '고객소개', '승인복제', '기타'];

const NEGATIVE_GROUPS = {
  A: { name: '스킬부족', reasons: ['거절사유 미파악', '단박거절', '인증미동의(국세청)', '인증미동의(공여내역)'] },
  B: { name: '설득실패', reasons: ['진행기간 미동의', '진행기간미동의', '자문료 미동의', '자문료미동의', '계약금미동의(선불)', '계약금미동의(후불)', '정체성 의심', '잘못 신청'] },
  C: { name: '관리누수', reasons: ['단기부재', '장기부재'] },
  D: { name: '불가피', reasons: ['인증불가', '정부기관 오인', '기타자금 오인', '불가업종', '매출없음', '신용점수 미달', '신용점수미달', '차입금초과', '본인아님', '사업자아님', '이중계약', '업력미달', '최근대출', '세금체납'] },
};
