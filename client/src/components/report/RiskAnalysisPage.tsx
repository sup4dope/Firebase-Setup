...
export function RiskAnalysisPage({
  ...
  const debtDistribution = [
    { name: "1금융권", value: debt1stTierPct, percentage: debt1stTierPct },
    { name: "2금융권", value: debt2ndTierPct, percentage: debt2ndTierPct },
    { name: "공공기관", value: debtPublicPct, percentage: debtPublicPct },
  ].filter(d => d.value > 0);

  const COLORS = ["#0A3D4C", "#14B8A6", "#C9A962"];
  ...
  return (
    <div className="w-[210mm] h-[297mm] bg-white shadow-lg p-[25mm] flex flex-col page-break">
      ...
      <div className="mt-auto pt-4 border-t border-gray-200 flex justify-between items-center text-xs text-[#4A5568]">
        ...
        <span className="font-semibold">Page 4 of 8</span>
      </div>
    </div>
  );
}
